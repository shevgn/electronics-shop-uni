          ...
          page !== 0 ? (
            <li key={index}>
              <button
                ...
                className={`h-6 w-6 rounded-lg border text-sm text-black transition-all hover:border-gray-300 sm:h-7 sm:w-7 md:h-8 md:w-8 md:text-base ${currentPage === page ? "bg-gray-200" : ""
                  }`}
              >
                <p>{page}</p>
              </button>
